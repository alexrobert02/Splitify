...
const getStyles = (c: ColorPalette) => StyleSheet.create({
  ...
  fabExtended: { position: 'absolute', bottom: 24, right: 20, backgroundColor: c.primary, borderRadius: 14, paddingHorizontal: 18, paddingVertical: 14, flexDirection: 'row', alignItems: 'center', gap: 8, shadowColor: c.primary, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 8, elevation: 6 },
  fabExtendedText: { fontSize: 15, fontWeight: '700', color: '#fff' },
  fabMenuOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.25)' },
  fabMenuSheet: { position: 'absolute', right: 20, backgroundColor: c.surface, borderRadius: 14, paddingVertical: 6, minWidth: 182, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.15, shadowRadius: 12, elevation: 10 },
  fabMenuItem: { flexDirection: 'row', alignItems: 'center', gap: 12, paddingHorizontal: 16, paddingVertical: 13 },
